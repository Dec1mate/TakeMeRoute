    ...
    <div class="row">
        <div class="col-12 top6 mb-2">
            <div class="container text-center">
                <!--FOREACH DEL TOP6-->
                <div class="row pt-1">
                    <div class="col-12" style="color: black; font-size: 120% ">Conductor</div>
                </div>
                <div class="row justify-content-around p-3">
                    <?php for($j=0;$j<count($conductor);$j++):?>
                        <div class="col-3 person">
                            <div class="container p-0">
                                <div class="row">
                                    <div class="offset-2 col-8 foto mt-1" >
                                        <img src="<?= $conductor[$j]->foto?>" width="100%" style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.4), 0 6px 20px 0 rgba(0, 0, 0, 0.2);">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 texto mt-1" >
                                        <?= $conductor[$j]->nombre?>
                                        <input class="nombre" type="hidden" value="<?=$conductor[$j]->dni?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <?php
...
<script>
    ...
    document.getElementById("finalizar").onclick=function () {
        ...
        for(let i=0;i<j.length;i++) {
            ...
            httpRequest.open("POST","valoraConductorv2.php",true);
            ...
            httpRequest.send('datos={"conductor":"<?= $_GET["conductor"]?>", "id":"<?=$_GET["id"]?>", "estrellas":"'+cont+'"}');
