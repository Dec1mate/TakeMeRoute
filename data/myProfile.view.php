        ...
        <div class="col-7">
            <div class="container p-0">
                <div class="row justify-content-around">
                    ...
                    <div id="garaje" class="col-5 rutas text-center slideshow p-0" style=" object-fit: cover; background: url('./img/anyadirCoche.jpg') center; background-size: cover">
                        <p style="background-color: rgba(255,255,255,0.6); padding: 5%;">Administrar Garaje</p>
                    </div>
                </div>
                <div class="row justify-content-around">
...
<script>
    ...
    document.getElementById("ruta").onclick=function () {
        location.href="./administrarRutas.php";
    }

    document.getElementById("garaje").onclick=function () {
        location.href="./administrarGaraje.php";
    }
